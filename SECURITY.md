...
Only the latest published version of `coolhand-node` on npm is supported with security fixes.
...
- [GitHub Security Advisories](https://github.com/Coolhand-Labs/coolhand-node/security/advisories/new)
