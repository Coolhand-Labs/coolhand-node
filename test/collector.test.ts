  ...
  it('should include collector field in logging payload structure', () => {
    ...
    const mockPayload = {
      llm_request_log: {
        ...
        collector: 'coolhand-node-0.1.0-global-monitoring'
      }
    };
    ...
    expect(mockPayload.llm_request_log.collector).toBe('coolhand-node-0.1.0-global-monitoring');
  });
...
describe('Expected API Payloads', () => {
  it('should create log payload with collector for global monitoring', () => {
    ...
    expect(expectedPayload.llm_request_log.collector).toBe('coolhand-node-0.1.0-global-monitoring');
  ...
  it('should create feedback payload with collector', () => {
    ...
    // This represents what should be sent to the API
    expect(expectedPayload.collector).toBe('coolhand-node-0.1.0-manual');
  ...
  it('should create log payload without collector field when not specified', () => {
    ...
    expect(baseCollector).toBe('coolhand-node-0.1.0');
    ...
    expect(expectedPayload.llm_request_log.collector).toBe('coolhand-node-0.1.0');
  });
});